const start = async function (component, components, ctx) {
  ...
  await store.dispatch('component/sendCommand', { ctx, name: 'BLOWERROOM_MOTOR_MBW02_Status', value: true })
  $notifyLoading.hide()
}
const stop = async function (component, components, ctx) {
  ...
  await store.dispatch('component/sendCommand', { ctx, name: 'BLOWERROOM_MOTOR_MBW02_Status', value: false })
  $notifyLoading.hide()
}
const changemode = async function (component, components, ctx) {
  ...
  await store.dispatch('component/sendCommand', { ctx, name: 'BLOWERROOM_MOTOR_MBW02_ManAut', value: !component.state.auto })
  $notifyLoading.hide()
}
