const start = async function (component, components, ctx) {
  ...
  await store.dispatch('component/sendCommand', { ctx, name: 'BLOWERROOM_MOTOR_MBW01_Run', value: true })
  $notifyLoading.hide()
}
const stop = async function (component, components, ctx) {
  ...
  await store.dispatch('component/sendCommand', { ctx, name: 'BLOWERROOM_MOTOR_MBW01_Stop', value: true })
  $notifyLoading.hide()
}
