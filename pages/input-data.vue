<template>
  <div class="page">
    ...
    <div class="screen tw-relative tw-flex-1">
      <div class="tw-bg-gray-200 tw-shadow-lg tw-rounded tw-h-full tw-mx-40 tw-my-10 tw-flex tw-flex-col tw-overflow-hidden">
        <div style="display: flex; flex: 1 1 0%;overflow-y: auto;" class="tw-flex-col">
          ...
          <div class="tw-flex-1 tw-py-4 tw-px-6 tw-justify-center tw-bg-gray-300">
            <table class="shadow-lg tw-w-full tw-mb-12">
              ...
              <tr v-for="(item, i) in items" :key="i" class="tw-bg-gray-200 hover:tw-text-gray-800 hover:tw-bg-gray-100">
                <td class="tw-border tw-border-gray-300 tw-px-8 tw-py-4">
                  <label for="toggle_1" class="tw-font-font tw-text-gray-800">
                    {{ item.name }}
                  </label>
                </td>
                <td class="tw-border tw-border-gray-300 tw-px-8 tw-py-4">
